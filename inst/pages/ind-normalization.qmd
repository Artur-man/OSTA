...
a key challenge in ST, that library size–based methods can distort biological 
signal and downstream analyses, motivating alternative normalization strategies. 
