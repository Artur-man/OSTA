...
```{r conda-create, warning=FALSE, message=FALSE, results="hide", include=FALSE}
env <- "py-interop"
conda_create(env, environment = system.file("extdata", "environment.yml", package="OSTA"))
use_condaenv(env, required=TRUE)
```

```{r conda-create, warning=FALSE, message=FALSE, results="hide", eval=FALSE}
...
```{r deps-conda-forge, warning=FALSE, message=FALSE, results="hide", eval=FALSE}
...
```{r deps-pypi, warning=FALSE, message=FALSE, results="hide", eval=FALSE}
